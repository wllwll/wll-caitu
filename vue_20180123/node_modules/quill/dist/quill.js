          ...
          if (fileInput == null) {
            ...
            fileInput.addEventListener('change', function () {
              if (fileInput.files != null && fileInput.files[0] != null) {
                ...
                let data = new FormData($('#loadImage')[0])
                data.append('file', file)
                $.ajax({
                  url: 'https://app1.shiyujia.com/admin/uploads/index',
                  type: 'POST',
                  data: data,
                  processData: false,
                  contentType: false,
                  ...
                  success: function (res) {
                    imgUrl = res.data
                    var range = _this3.quill.getSelection(true);
                    _this3.quill.updateContents(new _quillDelta2.default().retain(range.index).delete(range.length).insert({ image: imgUrl}), _emitter2.default.sources.USER);
                    _this3.quill.setSelection(range.index + 1, _emitter2.default.sources.SILENT);
                    fileInput.value = "";
                  }
                })
            ...
            forms.appendChild(fileInput)
            this.container.appendChild(forms);
          }
          fileInput.click();
        },
